...
public class Solver {
    ...
    private class NodeOrder implements Comparator<SearchNode> {
        public int compare(SearchNode p, SearchNode q) {
            if (p.moves + p.currMan < q.moves + q.currMan)
                return -1;
            else if  (p.moves + p.currMan 
                == q.moves + q.currMan)
                return 0;
...
//        System.setIn(new FileInputStream(new File("F://Libraries/Desktop/TestInput/puzzle/puzzle3x3-unsolvable.txt")));
